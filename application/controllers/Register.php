...
class Register extends CB_Controller
{
	...
	public function index()
	{
		...
		$view['view']['check'] = $this->checkplus->main();
		$view['view']['check'] = $this->checkplus->success();
	...
	public function checkplus_main(){
		//**************************************************************************************************************
		...
		*/
		...
		$returnurl = "https://dev.ciccommunity.com/checkplus_success";	// 성공시 이동될 URL
