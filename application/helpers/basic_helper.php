 ...
 * CIC 배너 출력하기
 */
if ( ! function_exists('cic_banner')) {
	function cic_banner($position = '', $type = 'rand', $limit = 1, $start_tag = '', $end_tag = '')
	{
		...
		$CI->load->model('CIC_Banner_model');
		$result = $CI->CIC_Banner_model->get_admin_list($position, $type, $limit);
