...
class Checkplus extends CI_Controller
{
	...
	public function main()
	{
		...
		*/
		...
		$returnurl = "https://dev.ciccommunity.com/register/auth_success";	// 성공시 이동될 URL
		$errorurl = "https://dev.ciccommunity.com/register/auth_fail";		// 실패시 이동될 URL
	...
	public function main_for_phone()
	{
		//**************************************************************************************************************
		//NICE평가정보 Copyright(c) KOREA INFOMATION SERVICE INC. ALL RIGHTS RESERVED
		...
		*/
		...
		// CheckPlus(본인인증) 처리 후, 결과 데이타를 리턴 받기위해 다음예제와 같이 http부터 입력합니다.
		// 리턴url은 인증 전 인증페이지를 호출하기 전 url과 동일해야 합니다. ex) 인증 전 url : http://www.~ 리턴 url : http://www.~
		$returnurl = "https://dev.ciccommunity.com/membermodify/auth_phone_success";	// 성공시 이동될 URL
		$errorurl = "https://dev.ciccommunity.com/membermodify/auth_fail";		// 실패시 이동될 URL
