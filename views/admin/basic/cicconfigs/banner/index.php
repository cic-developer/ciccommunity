				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><img src="<?php echo banner_image_url(element('ban_image', $result), '', 150); ?>" alt="<?php echo html_escape(element('ban_title', $result)); ?>" title="<?php echo html_escape(element('ban_title', $result)); ?>" class="thumbnail mg0" style="width:80px;" /></td>
