					...
					<table class="table table-hover table-striped table-bordered">
						...
						?>
							<tr>
								...
								<td><button  type="button" id="myBtn" class="btn btn-default btn-xs" onClick="document.location.href='https://dev.ciccommunity.com/admin/cicconfigs/coin/CStock_keyword?id=<?php echo element('market', $result); ?>'">Link</button></td>
							</tr>
						<?php
							}
						}
