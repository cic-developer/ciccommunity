					...
					<table class="table table-hover table-striped table-bordered">
						...
						<?php $myId = $_GET['id']; ?> 
							...
							<tr>
								...
								<td><a href="CStock_keyword/?id=<?php echo $stocks['idx']; ?>" class="btn btn-danger btn-xs">삭제 </a></td>
								<!-- <td><a href="<?php echo site_url('admin/cicconfigs/Coin/delete_keyword/'.$stocks['idx']) ?> ">delete<a></td> -->
								<td><button type=submit><a href="update_keyword/?id=<?php echo $stocks['idx']; ?>" class="btn btn-info btn-xs">수정 </a></button></td> 
							</tr>
							<?php } ?>	
						<?php
						}
