					...
					<table class="table table-hover table-striped table-bordered">
						...
						?>
							<tr data-idx="<?php echo element('post_id', $result)?>">
                                ...
                                <td><a href="<?php echo admin_url($this->pagedir); ?>/exchange_write/<?php echo element(element('primary_key', $view), $result); ?>?<?php echo $this->input->server('QUERY_STRING', null, ''); ?>" class="btn btn-outline btn-default btn-xs">포인트 배분</a></td>
							</tr>
						<?php
							}
						}
