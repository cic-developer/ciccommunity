				...
				<div class="box-table-header">
					...
					?>
						<div class="btn-group pull-right" role="group" aria-label="...">
							...
							<button type="button" class="btn btn-outline btn-default btn-sm btn-list-update btn-list-selected dissabled" data-list-update-url = "<?php echo element('update_disapproval_return_url', $view); ?>" >선택반려</button>
