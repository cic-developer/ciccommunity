					...
					<table class="table table-hover table-striped table-bordered">
						...
						if (element('list', element('data', $view))) {
							...
							<tr>
								...
								<td><a href="?news.comp_id=<?php echo element('news.comp_id', $result); ?>"><?php echo html_escape(element('comp_name', element('company', $result))); ?></a><span class="fa fa-external-link"></span></td>
