					...
					<table class="table table-hover table-striped table-bordered">
						...
						if (element('list', element('data', $view))) {
							...
							<tr>
								...
								<td><a href="?comp_id=<?php echo element('comp_id', $result); ?>"><?php echo html_escape(element('comp_name', element('company', $result))); ?></a> <a href="<?php echo goto_url(element('companydurl', $result)); ?>" target="_blank"><span class="fa fa-external-link"></span></a></td>
