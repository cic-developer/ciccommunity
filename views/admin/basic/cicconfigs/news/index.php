				...
				<div class="box-table-header">
					...
					?>
						<div class="btn-group pull-right" role="group" aria-label="...">
							<button type="button" class="btn btn-outline btn-default btn-sm btn-list-update btn-list-selected disabled" data-list-update-url = "<?php echo element('update_news_enable_1_url', $view); ?>" >비활성화</button>
						</div>
					<?php
