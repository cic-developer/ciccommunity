		...
		?>
			<div class="box-table-header">
				...
				<ul class="nav nav-pills">
					<li role="presentation" <?php echo $_pointType === 'cp' ? '': 'class="active"'?>><a href="<?php echo admin_url($this->pagedir.'/vp')?>">VP 관리</a></li>
					<li role="presentation" <?php echo $_pointType === 'cp' ? 'class="active"': ''?>><a href="<?php echo admin_url($this->pagedir.'/cp')?>">CP 관리</a></li>
