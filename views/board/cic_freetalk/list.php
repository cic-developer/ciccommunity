            ...
            <div class="real">
                <div class="fl">
                    ...
                    <ul>
						...
						?>
							<li>
								<a href="<?php echo goto_url(element('posturl', $bestpost)); ?>"><?php echo html_escape(element('post_title', $bestpost)); ?><span class="text-right"><?php echo number_format(element('post_like_point', $bestpost)); ?></span></a>
							</li>
						<?php
							}
						}
