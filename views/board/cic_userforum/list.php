            ...
            <div class="lower r">
                <div class="ov">
                    ...
                    ?>
                        ...
                        <a href="javascript:void(0);" class="by-btn" id="deposit_insert" style="display:none;"><span>CP 예치</span></a>
                    <?php }else { ?>
                        ...
                        <a href="javascript:void(0);" class="by-btn" id="deposit_insert" style="display:inline-block;"><span>CP 예치</span></a>
                    <?php 
                        }
                    } 
                    ?>
