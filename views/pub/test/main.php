...
<script type="text/javascript" src="./_Js/jquery/popup.js"></script>
...
<!-- s: #doc //-->
<div id="doc" class="main"> <!-- main / sub -->
	<!-- s: header-warp //-->
		...
		<div class="msec-cont">
			...
			<div class="msec-03">
				<div class="tits">
					...
					<p>이슈 투표에서 행사 수수료의 일부를 지급 받을 수 있습니다</p>
			...
			<div class="msec-04">
				<div class="cont">
					...
					<div class="img">
						...
						<p><img src="<?php echo base_url('assets/images/movie-cha.png')?>" alt="동영상목업"/></p>
					</div>
				</div>
			</div>
			<!-- e : msec-04 -->
