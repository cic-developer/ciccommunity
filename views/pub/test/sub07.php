	...
	<div id="container-wrap">
		...
		<div class="board-wrap detail">
			<div class="detail">
				...
				<div class="cons">
					<div class="txt">
						<div class="img first"><img src=<?php echo base_url('assets/images/record-img.jpg') ?>" alt="" class="natural-img" onload="javascript:myWidth(this);"/></div>
					...
					<ul>
						...
						<li>
							<a href="#n">
								...
								<div class="my-info">
									<p class="pimg"><img src="../_Img/Main/like-popo.png') ?>" alt=""/></p>
									<p class="rtxt">가즈아</p>
								</div>
								<span class="txt">[스압] 월급루팡이 만들어지는 과정 (5)</span> 
								<span class="vp">102,522</span>
					...
					<li class="item">
						<div class="vcon">
							<div class="info">
								...
								<div class="vp-point">	
									<ul>
										<li><p class="up">12</p></li>
										<li><p class="down">35</p></li>
									</ul>
								</div>
							</div>
							<div class="vtxt">
							...
							<div class="ctrls">
								<ul>
									<li><p class="date">21. 03. 04 19:08</p></li>
				...
				$(function(){
					...
					$('.cmmt-wrap').find('.singo-btn').click(function(){
						...
						$('.layer-wrap.singo').bPopup({
						 ...
						 $('.layer-wrap.singo').css({'top': obj.top ,'left': obj.left,'margin-top':'20px', 'margin-left':'0'});
						 $('.layer-wrap.singo').bPopup({
