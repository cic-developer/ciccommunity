			...
			<div class="entry">
				<ul>
					<li>
						...
						<div class="field">
							<p class="chk-input">
								<input type="text" value="dltngh2236@naver.com" autocomplete="off">
							</p>
					...
					<li>
						...
						<div class="field nick">
							<p class="chk-input">
								<input type="text" value="코린이1253" autocomplete="off">
							</p>
					...
					<li>
						...
						<div class="field nick">
							<p class="chk-input">
								<input type="text" value="ox12344556619982389" autocomplete="off">
							</p>
						</div>
